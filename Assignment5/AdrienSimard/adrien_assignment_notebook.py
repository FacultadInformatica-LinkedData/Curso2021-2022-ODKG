# -*- coding: utf-8 -*-
"""Adrien_Assignment-Notebook.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1WSuGczTjLdCjTWpKwAT0HjxXmads_P9S
"""
...
#          --return 'prop.label as Prop, count(distinct inst) as Freq' 
# """)
...
#SELECT ?a ?film ?aLabel ?filmLabel WHERE {
# ?film wdt:P161 wd:Q2685.
#  ?film wdt:P161 ?a.
#  FILTER (?a !=# wd:Q2685)
#  SERVICE wikibase:l#abel { bd:serviceParam wikibase:language "[AUTO_LANGUAGE],en". }
#}ORDER BY ?filmLabel"
...
kgtk("""
    query -i all
        ...
        --return 'cast_member as castMember, movies as Movie'
        / add-labels
""")
...
kgtk("""
    query  -i all -i $OUT/metadata.pagerank.undirected.tsv.gz
        --match '
