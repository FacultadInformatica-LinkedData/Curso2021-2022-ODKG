var sparql = {
  version: "sparql.js version 2021-11-05",
...
*/
sparql.query = function (endpoint, query, options) {
  return this.get(endpoint, query, options).then(sparql.parseResponse)
}
...
*/
sparql.get = function (endpoint, query, options) {
...
sparql.parseResponse = function(json) {
